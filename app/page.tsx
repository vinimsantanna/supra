      ...
      <Container>
        <div className="flex flex-col items-center justify-between gap-8 border-b border-white/10 pb-10 md:flex-row md:items-start">
          ...
          <p className="max-w-sm text-center text-sm leading-7 text-muted md:text-left">
            EstratÃ©gia, posicionamento e performance para negÃ³cios da saÃºde que precisam crescer com consistÃªncia.
          </p>
...
function RocketLaunchScene() {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      if (engaged) launchProgress = Math.min(1, launchProgress + 0.0029);
  ...
  return (
    <div
      ref={wrapperRef}
      className="relative h-full min-h-[520px] w-full overflow-visible lg:absolute lg:-right-[14vw] lg:-top-[280px] lg:bottom-[-420px] lg:min-h-[1240px] lg:w-[min(64vw,980px)]"
    >
